...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(authHeader == null || !authHeader.startsWith("Bearer ")) {
            if (!request.getRequestURI().startsWith("/kiubit/api/swagger") && !request.getRequestURI().startsWith("/kiubit/api/auth/authenticate")&& !request.getRequestURI().startsWith("/kiubit/api/auth/register")&&!request.getRequestURI().startsWith("/kiubit/api/v3/api-docs")&&!request.getRequestURI().startsWith("/kiubit/api/public")){
